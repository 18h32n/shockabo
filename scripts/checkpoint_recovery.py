...
from src.adapters.repositories.checkpoint_repository import CheckpointRepository, CheckpointMetadata
...
class CheckpointRecoveryTool:
    ...
    def analyze_training_session(self, task_id: str) -> Dict[str, Any]:
        ...
        print(f"\nAccuracy Progress:")
        for i, (checkpoint, accuracy) in enumerate(zip(checkpoints, accuracies)):
