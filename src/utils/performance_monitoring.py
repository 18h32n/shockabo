...
class PerformanceThresholds:
    ...
    def get_threshold(self, metric_type: PerformanceMetricType, threshold_type: str) -> Optional[float]:
        """Get threshold value for a metric."""
        return self.thresholds.get(metric_type, {}).get(threshold_type)
    
    def check_violation(self, metric: PerformanceMetric) -> Optional[PerformanceAlert]:
...
class InferenceProfiler:
    ...
    def __init__(self, collector: PerformanceCollector):
        ...
        self.current_inference_start: Optional[float] = None
...
class TrainingProfiler:
    ...
    def record_loss(self, loss: float, epoch: Optional[int] = None) -> None:
