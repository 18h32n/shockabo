...
class RateLimitingMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, rate_limits: Optional[Dict[str, RateLimiter]] = None):
...
def get_rate_limiting_middleware(custom_limits: Optional[Dict[str, RateLimiter]] = None) -> RateLimitingMiddleware:
